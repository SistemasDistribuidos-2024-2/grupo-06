...
import (
	"bufio"
	"context"
	pb "continente_folder/grpc/primary-reg" // Usamos el archivo proto que definimos antes
	"crypto/aes"
	"crypto/cipher"
	"encoding/hex"
	"log"
...
const (
	primaryNodeAddress = "container_primary_node:50052" // Dirección del Primary Node (cambiar si está en otra máquina)
