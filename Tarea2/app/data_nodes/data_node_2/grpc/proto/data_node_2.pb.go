...
func (x *DatosDigimon) Reset() {
	*x = DatosDigimon{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_node_2_proto_msgTypes[0]
...
func (*DatosDigimon) Descriptor() ([]byte, []int) {
	return file_data_node_2_proto_rawDescGZIP(), []int{0}
}
...
func (x *SolicitudAtributo) Reset() {
	*x = SolicitudAtributo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_node_2_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolicitudAtributo) Descriptor() ([]byte, []int) {
	return file_data_node_2_proto_rawDescGZIP(), []int{1}
}
...
func (x *AtributoDigimon) Reset() {
	*x = AtributoDigimon{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_node_2_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AtributoDigimon) Descriptor() ([]byte, []int) {
	return file_data_node_2_proto_rawDescGZIP(), []int{2}
}
...
func (x *Confirmacion) Reset() {
	*x = Confirmacion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_node_2_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Confirmacion) Descriptor() ([]byte, []int) {
	return file_data_node_2_proto_rawDescGZIP(), []int{3}
}
...
var File_data_node_2_proto protoreflect.FileDescriptor

var file_data_node_2_proto_rawDesc = []byte{
	0x0a, 0x11, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x32, 0x2e, 0x70, 0x72,
...
var (
	file_data_node_2_proto_rawDescOnce sync.Once
	file_data_node_2_proto_rawDescData = file_data_node_2_proto_rawDesc
)

func file_data_node_2_proto_rawDescGZIP() []byte {
	file_data_node_2_proto_rawDescOnce.Do(func() {
		file_data_node_2_proto_rawDescData = protoimpl.X.CompressGZIP(file_data_node_2_proto_rawDescData)
	})
	return file_data_node_2_proto_rawDescData
}

var file_data_node_2_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_data_node_2_proto_goTypes = []any{
...
var file_data_node_2_proto_depIdxs = []int32{
...
func init() { file_data_node_2_proto_init() }
func file_data_node_2_proto_init() {
	if File_data_node_2_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_data_node_2_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_data_node_2_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_data_node_2_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_data_node_2_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_data_node_2_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_data_node_2_proto_goTypes,
		DependencyIndexes: file_data_node_2_proto_depIdxs,
		MessageInfos:      file_data_node_2_proto_msgTypes,
	}.Build()
	File_data_node_2_proto = out.File
	file_data_node_2_proto_rawDesc = nil
	file_data_node_2_proto_goTypes = nil
	file_data_node_2_proto_depIdxs = nil
}
