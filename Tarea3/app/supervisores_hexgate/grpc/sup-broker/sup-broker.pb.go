...
type SupervisorRequest struct {
	...
	Region           string        `protobuf:"bytes,1,opt,name=region,proto3" json:"region,omitempty"`                                                                  // Nombre de la región (ej. Noxus)
	ProductName      string        `protobuf:"bytes,2,opt,name=product_name,json=productName,proto3" json:"product_name,omitempty"`                                     // Nombre del producto (ej. Vino)
	OperationType    OperationType `protobuf:"varint,3,opt,name=operation_type,json=operationType,proto3,enum=supbroker.OperationType" json:"operation_type,omitempty"` // Tipo de operación: AGREGAR, RENOMBRAR, ACTUALIZAR, BORRAR
	Value            *int32        `protobuf:"varint,4,opt,name=value,proto3,oneof" json:"value,omitempty"`                                                             // Valor opcional (cantidad) para agregar o actualizar
	NewProductName   *string       `protobuf:"bytes,5,opt,name=new_product_name,json=newProductName,proto3,oneof" json:"new_product_name,omitempty"`                    // Nuevo nombre opcional en caso de renombrar
	KnownVectorClock *VectorClock  `protobuf:"bytes,6,opt,name=known_vector_clock,json=knownVectorClock,proto3,oneof" json:"known_vector_clock,omitempty"`              // Reloj vectorial conocido por el Supervisor
}
...
type ServerResponse struct {
	...
	Status      ResponseStatus `protobuf:"varint,1,opt,name=status,proto3,enum=supbroker.ResponseStatus" json:"status,omitempty"` // Estado de la operación (OK o ERROR)
	VectorClock *VectorClock   `protobuf:"bytes,2,opt,name=vector_clock,json=vectorClock,proto3" json:"vector_clock,omitempty"`   // Reloj vectorial asociado al registro procesado
	Value       *int32         `protobuf:"varint,3,opt,name=value,proto3,oneof" json:"value,omitempty"`                           // Valor del producto procesado (si corresponde)
...
var file_sup_broker_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x09, 0x73, 0x75, 0x70, 0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x22, 0xda, 0x02,
	...
	,
...
var file_sup_broker_proto_depIdxs = []int32{
	...
	4, // 1: supbroker.SupervisorRequest.known_vector_clock:type_name -> supbroker.VectorClock
	1, // 2: supbroker.ServerResponse.status:type_name -> supbroker.ResponseStatus
	4, // 3: supbroker.ServerResponse.vector_clock:type_name -> supbroker.VectorClock
	2, // 4: supbroker.BrokerService.ProcessRequest:input_type -> supbroker.SupervisorRequest
	3, // 5: supbroker.BrokerService.ProcessRequest:output_type -> supbroker.ServerResponse
...
func file_sup_broker_proto_init() {
	...
	file_sup_broker_proto_msgTypes[0].OneofWrappers = []any{}
	file_sup_broker_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
