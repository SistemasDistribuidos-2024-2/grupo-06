...
import (
	...
	jayceserver_pb "servidor_2/grpc/jayce-server"
	servbroker_pb "servidor_2/grpc/serv_broker" // Comunicación con el Broker
	supserv_pb "servidor_2/grpc/sup-serv"       // Comunicación con Supervisores
